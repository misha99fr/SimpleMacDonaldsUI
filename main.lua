...
local workspace, window, menu = system.addWindow(GUI.filledWindow(1, 1, 50, 16, 0xff0000))

local layout = window:addChild(GUI.layout(1, 1, window.width, window.height, 1, 1))

local label = layout:addChild(GUI.label(1, 1, 25, 1, 0xFFFFFF, "Welcome to MCdonalds, OUR MENU:"))
...
button3.onTouch = function()
  window:remove()
  GUI.alert("Also check OPENOS VERSION on my github: github.com/cackemc")
end
